...
# --- USA & KANADA (Urval av de största pga storlek) ---
# För att få alla 6000+ krävs filimport, detta är "All-Stars"
US_ALL_STAR = [
    "AAPL", "MSFT", "NVDA", "AMZN", "GOOGL", "META", "TSLA", "BRK-B", "LLY",
    "AVGO", "JPM", "V", "TSM", "WMT", "XOM", "UNH", "MA", "PG", "JNJ", "COST",
    "HD", "MRK", "ABBV", "CVX", "CRM", "BAC", "AMD", "NFLX", "KO", "PEP",
    "ADBE", "DIS", "TMO", "MCD", "CSCO", "ACN", "ABT", "LIN", "WFC", "DHR",
    "INTU", "VZ", "QCOM", "IBM", "CMCSA", "PM", "NKE", "AMGN", "NOW", "PFE",
    "TXN", "GE", "UNP", "SPGI", "CAT", "UBER", "HON", "AMAT", "RTX", "BA",
    "LOW", "COP", "ISRG", "GS", "PLD", "BKNG", "T", "BLK", "SYK", "ELV",
    "DE", "MDT", "LRCX", "TJX", "AXP", "VRTX", "ADI", "C", "MMC", "MDLZ",
    "MU", "PANW", "BX", "LMT", "ADP", "GILD", "REGN", "FI", "CB", "CI",
    "SCHW", "SNOW", "PLTR", "COIN", "MAR", "KLAC", "BSX"
]

CA_ALL_STAR = [
    "RY.TO", "TD.TO", "SHOP.TO", "ENB.TO", "CNR.TO", "CP.TO", "CNQ.TO",
    "BMO.TO", "BNS.TO", "ATD.TO", "TRI.TO", "SU.TO", "CM.TO", "BCE.TO",
    "TRP.TO", "CSU.TO", "NTR.TO", "MFC.TO", "IMO.TO", "ABX.TO", "GIB-A.TO",
    "L.TO", "POW.TO", "WCN.TO", "AEM.TO", "RCI-B.TO", "TECK-B.TO", "FTS.TO",
    "DOL.TO", "T.TO", "NA.TO", "WPM.TO", "SLF.TO", "QSR.TO", "FM.TO"
]